...
//     //     const canvasMain = this.shadowRoot.getElementById("blank-canvas-main");
//     //     console.log(elem.childElementCount);

//     //     let canvasChild = canvasMain.children;
//     // }
...
//       _onDragOver(e) {
//         e.preventDefault();
//         const targetIndex = parseInt(e.target.closest('.canvas-element').getAttribute('key'));
//         if (targetIndex !== this._draggedElementIndex && targetIndex !== undefined) {
...
//         if (droppedIndex !== undefined && droppedIndex !== this._draggedElementIndex) {
//           const [removed] = this._elements.splice(droppedIndex, 1);
//           this._elements.splice(this._draggedElementIndex, 0, removed);
//           this._draggedElementIndex = undefined;
//           this.requestUpdate(); // Update the component to reflect the reorder
//         }
...
export class BlankCanvas extends LitElement{
    ...
    _onDragStart(e, index) {
        ...
        // this._offsetX = e.clientX - this._draggedElement.getBoundingClientRect().left;
        // this._offsetY = e.clientY - this._draggedElement.getBoundingClientRect().top;
    ...
    _onDrag(e, index) {
        if (this._draggedElement) {
            e.preventDefault();
            // const saved = this.pointerMap.get(index);
            // const current = { ...saved.currentPos };
            // saved.currentPos = { x: e.clientX, y: e.clientY };
            // const delta = {
            //     x: saved.currentPos.x - current.x,
        ...
        //   this._draggedElement.style.top = y + 'px';
          // Implement logic to reorder elements based on new positions
        }
    }
